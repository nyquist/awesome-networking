...
- [Obelinf Toolkit](https://obelinf.com/toolkit/) - Free browser-based network toolkit with IP and subnet calculators, VLAN planning, device naming conventions, checklists, and reference tables.
